...
public interface IAdminDocumentService
{
    ...
    Task<AdminDocumentDto> UploadAsync(UploadDocumentRequest request, Stream fileContent, string fileName, string mimeType, int pageCount, CancellationToken cancellationToken = default);

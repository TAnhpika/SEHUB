...
public static class ChatbotDefaults
{
    ...
    public const string SystemPrompt =
        ...
        ## Quy tắc trả lời
        - Luôn tiếng Việt, thân thiện, 3–10 câu; bullet khi liệt kê gói/quyền lợi.
        - Hỏi về Premium/giá/quyền lợi: trả lời TRỰC TIẾP bằng bảng gói và bước mua ở /home/premium — không nói chung chung "xem trên web".

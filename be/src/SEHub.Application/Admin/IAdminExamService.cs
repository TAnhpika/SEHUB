...
public interface IAdminExamService
{
    ...
    Task<AdminExamDto> UpdateExamAsync(Guid id, UpdateExamRequest request, bool confirmDuplicate = false, CancellationToken cancellationToken = default);
    ...
    Task<AdminExamDto> ResubmitExamAsync(Guid id, ResubmitExamRequest request, bool confirmDuplicate = false, CancellationToken cancellationToken = default);
    Task<AdminExamDto> CreateRevisionAsync(Guid publishedExamId, CancellationToken cancellationToken = default);
    Task DeleteExamAsync(Guid id, CancellationToken cancellationToken = default);
}

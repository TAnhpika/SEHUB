...
function ExamDetailPage({ page }) {
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles["exam-panel"]} aria-label="Nội dung đề thi">
      ...
      <section className={styles.related} aria-label="Đề thi liên quan">
        <div className={styles["related-head"]}>
          <h2 className={styles["related-title"]}>Đề thi liên quan</h2>
          <button type="button" className={styles["related-more"]}>
            Xem thêm
          </button>
        </div>
